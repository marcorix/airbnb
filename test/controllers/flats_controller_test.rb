...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference("Flat.count") do
      post flats_url, params: { flat: { address: @flat.address, description: @flat.description, guests: @flat.guests, name: @flat.name, price: @flat.price } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { address: @flat.address, description: @flat.description, guests: @flat.guests, name: @flat.name, price: @flat.price } }
